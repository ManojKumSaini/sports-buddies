...
data_folder = "/Users/dave/Downloads/Basic_LinkedInDataExport_07-01-2025.zip"  # <-- Change this to your folder path
...
output_file = os.path.join("user_data", "linkedin_dave.json")
